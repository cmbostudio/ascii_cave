...
// [스노우볼 수정] 중후반 장비(다이너마이트~하이퍼드릴)의 DMG 보너스는
// stats.js의 getCalculatedMiningDMG()에서 고정 수치가 아닌 "% 배율"로 계산됨.
// 이 파일의 price만으로는 밸런스가 안 잡히니, 값 조정 시 stats.js의
// ITEM_DMG_PCT 테이블도 함께 고려할 것 (시뮬레이션 기준 최적 플레이 시 20구역 약 200h).
...
const SHOP_ITEMS = [
    ...
    { id: "item_dynamite", name: "양자 다이너마이트", desc: "채굴 타격 시 주변 8방향 광석에 30% 스플래시 피해 발생 & 채굴 데미지 +6% 배율 증가.", price: 500000000 },
    { id: "item_nano_glove", name: "나노 강화 장갑", desc: "채굴 데미지 +10% 배율 증가 & 15% 확률로 2배 크리티컬 채굴.", price: 10000000000 },
    { id: "item_overclock", name: "오버클럭 모터", desc: "이동 속도 +3.0/초 추가 증가 & 채굴 데미지 +12% 배율 증가.", price: 250000000000 },
    { id: "item_ether_radar", name: "에테르 공명 센서", desc: "환생 시 최종 획득 에테르 금액 +25% 증폭 & 채굴 데미지 +12% 배율 증가.", price: 7500000000000 },
    { id: "item_alchemy_bag", name: "차원 연금술 가방", desc: "가방 용량 +50 확장 & 광물 판매가 +30% 추가 상승 & 채굴 데미지 +12% 배율 증가.", price: 200000000000000 },
    { id: "item_god_pickaxe", name: "신성한 에테르 곡괭이", desc: "채굴 데미지 +15% 배율 증가 & 이동 속도 +1.5/초 추가 증가.", price: 5000000000000000 },
    { id: "item_hyper_drill", name: "초시공 하이퍼 드릴", desc: "차원을 뚫는 파괴력. 채굴 데미지 +18% 배율 증가.", price: 100000000000000000 }
];
